...
def load_p4(p4_file, p4_version=16, add_attrs=True):
    ...
    if add_attrs:
        set_additional_attrs(hlir,p4_file, p4_version)
...
if __name__ == "__main__":
    ...
    p4_version=14
    program1 = load_p4(sys.argv[1], p4_version)
    program2 = load_p4("t4p4s/examples/l3fwd-wo-chksm-gen.p4",p4_version)
    decltypes = [
    ...
    merger = P4Merger(program1,program2)
    merger.run()
    #print(program1.headers < 3)
